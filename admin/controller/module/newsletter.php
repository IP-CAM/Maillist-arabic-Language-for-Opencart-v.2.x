...
class ControllerModuleNewsletter extends Controller {
	...
	public function index() {   
		...
		$data['data'] = $this->url->link('module/newsletter/data', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function delete() {
		...
		$this->response->redirect($this->url->link('module/newsletter/data', 'token=' . $this->session->data['token'], 'SSL'));
	...
	public function data() {   
		...
		$data['export'] = $this->url->link('module/newsletter/export', 'token=' . $this->session->data['token'], 'SSL');
		$data['send'] = $this->url->link('module/newsletter/send', 'token=' . $this->session->data['token'], 'SSL');
		$data['delete'] = $this->url->link('module/newsletter/delete', 'token=' . $this->session->data['token'], 'SSL');

		$this->load->model('module/newsletter');
		$data['data'] = $this->model_module_newsletter->getData();

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
				
		$this->response->setOutput($this->load->view('module/newsletter_data.tpl', $data));
	}
	...
	public function send() {
		...
		$data['cancel'] = $this->url->link('module/newsletter/data', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('module/newsletter_send.tpl', $data));
	}
}
?>